...
export const HeadSection = () => {
    ...
    return (
        <section className=" w-full flex flex-col md:flex-row gap-4 justify-between">
            <div className=" px-6 py-4 w-full flex flex-col-reverse md:flex-row justify-between items-center gap-4 text-white bg-gradient-to-r from-indigo-400 to-indigo-500 rounded">
