...
export const EventCard = ({isReverse = false}) => {
    ...
    console.log(Image);
    return (
        <div className={` flex flex-col  ${isReverse ? ' sm:flex-row-reverse' : ' sm:flex-row'} items-center rounded-md`}>
            <img 
            src={''}
            ...
            <div className=" max-w-xl px-6 py-8  bg-[#0041E8] bg-opacity-20 flex flex-col gap-4 rounded">
                <h2 className={` text-2xl font-bold ${isReverse ? ' sm:self-end' : ''}`}>Event 1</h2>
